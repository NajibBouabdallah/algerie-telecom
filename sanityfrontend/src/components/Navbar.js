...
import { stcb,menu,close } from '../assets'
...
const Navbar = () =>{
    ...
    return(
        ...
        <nav className={`${styles.paddingX} w-full flex item-center py-5 fixed top-0 z-20 bg-[#ffffff]`}>
            <div className="w-full flex justify-between itens-center max-w-7x1 mx-auto">      
                <Link to="/" className='flex item-center gap-2' onClick={()=>{
                    setActive('');
                    window.scrollTo(0,0);
                }}>
                    <img src={stcb} alt="logo" className="w-9 h-7 object-contain"  />
                    <p className='text-slate-800 text-[18px] font-bold cursor-pointer flex'>
                        <span className='sm:block hidden'>Algerie Telecome </span>  </p>
                </Link>
                ...
                <div className='sm:hidden flex flex-1 justify-end items-center'>
                    ...
                    top-20 right-0 mx-4 my-2 z-10 rounded-xl min-w-[140px]`}>
